...
const toolName = "list-ecommerce-fulfillment-exceptions";
const configArgs = ["--config", path.join(__dirname, "..", "assets", "tools.yaml")];
...
function main() {
    ...
    const args = process.argv.slice(2);
		...
		const npxArgs = ["--yes", "@toolbox-sdk/server@1.6.0", "--log-level", "error", ...configArgs, "invoke", toolName, "--user-agent-metadata", userAgent, ...processedArgs];
